              ...
              >
                ...
                <div className="relative p-8">
                  <dt className="flex flex-col items-center text-center gap-y-4">
                    ...
                    {/* Feature title */}
                    <div className="text-lg font-semibold text-gray-900 group-hover:text-indigo-600 transition-colors duration-300">
                      {feature.name}
                    </div>
                  </dt>
                  ...
                  <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    <p className="flex-auto text-center group-hover:text-gray-700 transition-colors duration-300">
                      {feature.description}
                    </p>
