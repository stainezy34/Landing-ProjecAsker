...
export function FeatureLayout({ feature, currentPath }: FeatureLayoutProps) {
  ...
  return (
    <div className="bg-white pt-24 sm:pt-32">
              ...
              return (
                <div key={benefit.title} className="flex flex-col">
                  <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                    <BenefitIcon className="h-5 w-5 flex-none text-indigo-600" />
                    {benefit.title}
                  </dt>
        ...
        <div className="mt-16 sm:mt-24">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl rounded-3xl sm:px-24 xl:py-32">
            ...
            <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">
              Try our platform and see how it can transform your workflow.
            </p>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">
                Try our {feature.title.toLowerCase()} today and see how it can transform your project management workflow.
              </p>
      ...
      {/* Feature Navigation */}
      <FeatureNavigation currentPath={currentPath} />
    </div>
  );
}